...
#' @author Richard Huang, Department of Statistics, Rice University, 2015
#' 
#' @param o An object of class \code{OptPx}.
#' @param Smax The maximum asset price achieved to date.
#' @param Smin The minimum asset price achieved to date.
...
#'  LookbackMC(o,NPaths=10000,div=1000) #Output: 7.79 from Hull 9e Example 26.2 Pg 608. 
#'   
#'  # Floating & Call
#'  o=OptPx(Opt(S0=50,K=50,ttm=0.25,Right='Call',Style="Lookback"),r=0.1,vol=.4)
#'  LookbackMC(o,NPaths=10000,div=1000) #Output: 8.04 from Hull 9e Example 26.2 Pg 608 
#'   
#'  # Fixed & Put
#'  o=OptPx(Opt(S0=50,K=60,ttm=1,Right='Put',Style="Lookback"),r=0.05,q=0.02,vol=.25)
#'  LookbackMC(o,Type="Fixed",NPaths=10000,div=1000)
#'
#'  # Fixed & Call
...
#' @references LookbackBS.R files.
#'
#' @export
LookbackMC=function(o=OptPx(Opt(Style='Lookback'),r=0.05,q=0,vol=0.3,),
                    NPaths=10000,div=1000,Type = c("Floating", "Fixed")){
  stopifnot(is(o,'OptPx'), o$Style$Name=='Lookback',is.character(Type), is.numeric(NPaths),is.numeric(div))  #---Condition
  o.class = class(o)
